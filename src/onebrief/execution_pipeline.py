    ...
    def _run_adk_document_convergence(
        ...
        *,
        ...
        maker_instruction = (
            ...
            "content. Every material claim must cite a supplied F-prefixed finding ID, a grounded W-prefixed "
            "source ID from the supplied registry, or a direct source URL. Never change the goal, "
            "invent evidence, or make a high-impact human decision. For public research, expose direct source "
            "URLs beside the claims or rows they support; invented W IDs are not valid. Never infer that "
    ...
    def _run_adk_development_convergence(
        ...
        *,
        ...
        maker_instruction = (
            ...
            "When a new caller receives a compiler accessibility error from a preserved dependency, never widen "
            "that dependency's private or protected member merely to make the caller compile. Repair the new caller "
            "to use an existing public control, listener, interface, or approved adapter and keep the preserved "
