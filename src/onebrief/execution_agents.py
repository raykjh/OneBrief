    ...
    def run(
        ...
        result = self.gateway.generate_json(
            ...
            system_instruction=(
                ...
                "an unsupported causal idea may be retained only as an explicit hypothesis with a concrete test or pilot "
                "and a boundary against presenting it as established before validation. Health prevention or treatment "
