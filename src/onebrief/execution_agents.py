...
class DeveloperAgent:
    ...
    def run(
        ...
        base_instruction = (
            ...
            "will change Screen.width or Screen.height in batchmode. "
            ...
            "both a mobile/portrait and desktop/landscape viewport. Never label a direct SceneManager.LoadScene call as a "
